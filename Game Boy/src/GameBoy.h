...
#ifndef GAMEBOY_SRC_GAMEBOY_H_
#define GAMEBOY_SRC_GAMEBOY_H_
...
//---------------------------------------------------------------------------------------- Crear conexion (Devuelve socket del cliente)
...
//-------------------------------------------------------------------------------------------------------------------- Envíos Y Recepciones De Mensajes
